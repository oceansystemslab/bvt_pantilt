...
while true; do
	...
	rostopic pub -1 /pantilt/orientation_request blueview_pantilt/PanTiltOrientation "{azimuth: 45, elevation: 0}"
	sleep 4

	rostopic pub -1 /pantilt/orientation_request blueview_pantilt/PanTiltOrientation "{azimuth: 45, elevation: 30}"
	sleep 4
